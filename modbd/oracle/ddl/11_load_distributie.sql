...
-- 'NULL' (string) e tradus in valoare NULL prin NULLIF / CASE.
-- NOLOGFILE/NOBADFILE/NODISCARDFILE: mount-ul /csv e read-only (':ro' in docker),
--   deci dezactivam scrierea de log-uri ale ORACLE_LOADER.
-- =============================================================================
