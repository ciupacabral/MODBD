...
--
--   ext_fise_all   (DOCS_HEADERS.csv)
--     -> INSERT in fise_clienti_ro   WHERE moneda  = 'RON'
--     -> INSERT in fise_clienti_ext  WHERE moneda <> 'RON'
--
--   ext_linii_all  (DOCS_LINES.csv)
--     -> INSERT in linii_doc_ro   WHERE EXISTS (matching fise in fise_clienti_ro)
--     -> INSERT in linii_doc_ext  WHERE EXISTS (matching fise in fise_clienti_ext)
--
-- Cele 2 INSERT-uri pe LINII implementeaza fragmentarea orizontala DERIVATA
-- (semijoin pe cheia compusa nr_document + doc_type_xrp, curs cap. 2.3.2).
--
-- Convenții la fel ca in 11_load_distributie.sql (LRTRIM + NOLOGFILE etc.).
-- =============================================================================


-- ============================================================================
-- External table pentru documente (DOCS_HEADERS.csv)
-- ============================================================================
...
-- ============================================================================
-- INSERT in FISE_CLIENTI_RO (fragment H primar 1: moneda = 'RON')
-- ============================================================================
...
-- ============================================================================
-- INSERT in FISE_CLIENTI_EXT (fragment H primar 2: moneda <> 'RON')
-- ============================================================================
...
-- ============================================================================
-- External table pentru linii (DOCS_LINES.csv)
-- ============================================================================
...
-- ============================================================================
-- INSERT in LINII_DOC_RO (semijoin: linii al caror header e in fise_clienti_ro)
-- ============================================================================
...
-- ============================================================================
-- INSERT in LINII_DOC_EXT (semijoin: linii al caror header e in fise_clienti_ext)
-- ============================================================================
